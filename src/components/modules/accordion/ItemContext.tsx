...
export const Context = createContext(
  {} as {
    ...
    setTriggerAttributes: React.Dispatch<
      React.SetStateAction<InjectedTriggerAttributes>
    >
    panelAttributes: InjectedPanelAttributes
    setPanelAttributes: React.Dispatch<
      React.SetStateAction<InjectedPanelAttributes>
    >
...
export const Provider: React.FC<Props> = props => {
  ...
  const isInitialExpanded =
    rootContext.accordionState.defaultExpandedPanels === undefined
      ? false
      : rootContext.accordionState.defaultExpandedPanels.includes(
          props.panelIndex
        )
  ...
  // トリガーの状態管理
  const [triggerAttributes, setTriggerAttributes] =
    useState<InjectedTriggerAttributes>({
  ...
  // パネルの状態管理
  const [panelAttributes, setPanelAttributes] =
    useState<InjectedPanelAttributes>({
